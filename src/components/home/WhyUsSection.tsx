...
const timeline = [
  ...
  { year: '2021', sv: 'ÅRETS FRISKT VÅGAT',            en: 'BOLDEST BET' },
  { year: '2022', sv: 'SVERIGES BÄSTA',                 en: 'SWEDEN\'S BEST' },
  { year: '2023', sv: 'FASADEN SOM VÄGRADE TYSTAS',    en: 'THE WALL THAT REFUSED TO BE SILENCED' },
